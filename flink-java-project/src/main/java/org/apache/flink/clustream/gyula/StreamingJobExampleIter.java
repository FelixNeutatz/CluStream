 ...
 */
public class StreamingJobExampleIter {
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File(classLoader.getResource("data/test.csv").getFile());
		...
		IterativeStream.ConnectedIterativeStreams<Tuple2<Long,Integer>, Average> inputsAndCentroids = input.iterate().withFeedbackType(Average.class);

		DataStream<Average> updatedCentroids = inputsAndCentroids.flatMap(new MyCoFlatmap(2)).setParallelism(parallelism);
