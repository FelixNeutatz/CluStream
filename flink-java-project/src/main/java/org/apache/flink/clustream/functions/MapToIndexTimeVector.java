 ...
 */
public class MapToIndexTimeVector implements MapFunction<String, Tuple3<Long,Long,Vector>> {
	@Override
	public Tuple3<Long,Long,Vector> map(String value) throws Exception {
		...
		return new Tuple3<Long, Long, Vector>(System.nanoTime() % 1000, Long.parseLong(splits[0]), new DenseVector(values));
	}
}
